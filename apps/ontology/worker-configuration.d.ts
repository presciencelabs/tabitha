/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: 2ba4368954feedc6c88af546f24c1bc9)
...
interface __BaseEnv_Env {
	...
	DB_Auth: D1Database;
	VECTORIZE_Concepts: VectorizeIndex;
	RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	PUBLIC_SOURCES_API_HOST: string;
	PUBLIC_TARGETS_API_HOST: string;
	PUBLIC_CORS_ALLOW_LOCALHOST: string;
	PUBLIC_RATE_LIMIT_DISABLED: string;
	OAUTH_REDIRECT_PROXY_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SOURCES_API_HOST" | "PUBLIC_TARGETS_API_HOST" | "PUBLIC_CORS_ALLOW_LOCALHOST" | "PUBLIC_RATE_LIMIT_DISABLED" | "OAUTH_REDIRECT_PROXY_URL" | "GOOGLE_OAUTH_CLIENT_ID" | "CLOUDFLARE_ACCOUNT_ID" | "GEMINI_PROJECT_ID" | "GEMINI_LOCATION" | "AUTH_SECRET" | "GOOGLE_OAUTH_CLIENT_SECRET" | "AI_GATEWAY_TOKEN" | "SCHEDULER_TOKEN">> {}
}
